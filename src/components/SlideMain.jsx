...
const SlideMain = ({ title, description, profilePic, video, videoMobile, logoUrl, preload = 'auto', isMobile = false, isActiveSlide = false, videosCanLoad = true }) => {
  ...
  const activeSrc = (isActiveSlide || videosCanLoad) ? videoSrc : undefined;
